...
- Version bump for 1.5.7 release; docs synced (README, manual) and release zip prepared for auto-updater.
...
- Version shown again in the app header banner (fetched from `/api/version`).
