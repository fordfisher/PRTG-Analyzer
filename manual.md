...
Results are cached on the SHA-256 hash of the file *and* the analyzer version string (`1.5.1`). Upgrading PyPRTG_CLA automatically forces a fresh analysis.
...
*PyPRTG_CLA v1.5.1 — PRTG Core Log Analyzer*  
