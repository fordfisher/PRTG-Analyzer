...
```
   ...
   For releases: name the EXE with the version (e.g. `PyPRTG_CLA_v1.5.exe`) to match the auto-update mechanism — set `name='PyPRTG_CLA_v1.5'` in the spec or rename the output.
